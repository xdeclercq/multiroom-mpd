...
public class ZonePlaylistResource {
     ...
     */
    public ZonePlaylistResource(final ZoneDto zoneDto,
                                final ZonePlaylistService zonePlaylistService,
    ...
    @POST
    @Path("{position}/play")
    public Response play(@PathParam("position") final Integer position) {
