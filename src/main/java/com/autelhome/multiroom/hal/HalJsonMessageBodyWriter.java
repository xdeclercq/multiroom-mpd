...
public class HalJsonMessageBodyWriter implements MessageBodyWriter<ReadableRepresentation> {
    ...
    @Override
    public long getSize(final ReadableRepresentation representation, final Class<?> type,
    ...
    @Override
    public void writeTo(final ReadableRepresentation representation, final Class<?> type,
                        final Type genericType, final Annotation[] annotations, final MediaType mediaType,
